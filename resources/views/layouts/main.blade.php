...
<head>
    ...
    <title>@yield('pageTitle') - Jasamedika Tes</title>
...
<body id="page-top">
    ...
    <script src="{{ asset('assets/sb/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('assets/sb/js/demo/chart-pie-demo.js') }}"></script>
